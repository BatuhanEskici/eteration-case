        ...
        <div className="bg-white shadow-lg p-3">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                    <button className="bg-slate-200 w-[25px] h-[25px] flex items-center justify-center rounded">-</button>

                    <span className="bg-[#2A59FE] text-white w-[27.5px] h-[27.5px] flex items-center justify-center">2</span>
